...
```{r}
#| label: scatterplot
#scatterplot of relationship between weight and hind foot length
ggplot(data = surveys,
       mapping = aes(x =weight, y = hindfoot_length,)) +
  geom_point(alpha=0.2)+
  facet_wrap(~species)+
  labs(subtitle = "Hind Foot Length", y= "")
```
...
ggplot(data = surveys,
  ...
  facet_wrap(~species)+
  labs(subtitle = "Hind Foot Length", y= "", axis.text.y=45) +
  geom_jitter(alpha=0.2, color= "springgreen4")
